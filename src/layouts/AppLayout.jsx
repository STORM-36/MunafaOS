...
const AppLayout = () => {
  ...
  return (
    <div className="flex h-screen bg-[#F6F8FC] overflow-hidden font-sans">
      ...
      >
        <div className="h-[90px] px-5 border-b border-[#B8C5D8] w-full flex items-center">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto pt-16 md:pt-0">
        <div className="sticky top-0 z-30 bg-white border-b border-[#B8C5D8] px-4 md:px-6 h-[90px] flex items-center">
